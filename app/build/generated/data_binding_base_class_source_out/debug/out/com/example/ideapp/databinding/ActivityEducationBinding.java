...
public final class ActivityEducationBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialToolbar toolbarEducation;

  @NonNull
  public final TextView tvEducation;

  private ActivityEducationBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialToolbar toolbarEducation, @NonNull TextView tvEducation) {
    this.rootView = rootView;
    this.toolbarEducation = toolbarEducation;
  ...
  public static ActivityEducationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.toolbar_education;
      MaterialToolbar toolbarEducation = ViewBindings.findChildViewById(rootView, id);
      if (toolbarEducation == null) {
        break missingId;
      }
      ...
      return new ActivityEducationBinding((ConstraintLayout) rootView, toolbarEducation,
          tvEducation);
    }
