...
class AboutUsFragment : Fragment() {
    override fun onCreateView(
        ...
        aboutUsDescription.text = if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
    android.text.Html.fromHtml(getString(R.string.about_us_description), android.text.Html.FROM_HTML_MODE_LEGACY)
} else {
    android.text.Html.fromHtml(getString(R.string.about_us_description))
}
        return view
    }
}
