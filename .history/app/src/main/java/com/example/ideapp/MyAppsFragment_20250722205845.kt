    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        inProgressListener = db.collection("ideas")
            ...
            .addSnapshotListener { snapshot, exception ->
                ...
                tvInProgressCount.text = getString(R.string.count_in_progress, allInProgressIdeas.size)
        ...
        db.collection("ideas")
            ...
            .addSnapshotListener { snapshot, exception ->
                ...
                tvCompletedCount?.text = getString(R.string.count_ready, completedApps.size)
